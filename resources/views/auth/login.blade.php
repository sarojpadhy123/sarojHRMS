...
<body>
    <div class="page login-page" style="background-image: url('{{ asset('public/uploads/asset_file/auth-bg.jpg') }}')">
        <div class="container">
            ...
            <div class="form-outer text-center d-flex align-items-center">
                    ...
                    <form method="POST" action="{{ route('login') }}" id="login-form">
                        ...
                        <div class="form-group-material">
                            ...
                            <input id="username" type="text"
                                class="input-material @error('username') is-invalid @enderror" name="username"
                ...
                <div class="copyrights text-center">
                    <p>{{ __('Developed by') }} <a href={{ $general_settings->footer_link }}
