                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="footer_link" placeholder="https://www.XXXXXXX.com" class="form-control" value="<?php echo e($general_settings_data->footer_link ?? ''); ?>" required />
                                        </div>
                                    </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/users/shariqq/power-people-hrm/public_html/resources/views/settings/general_settings/index.blade.php ENDPATH**/ ?>