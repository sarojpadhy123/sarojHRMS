...
<head>
    ...
    <script type="text/javascript" src="<?php echo e(asset('public/vendor/jquery-clockpicker/bootstrap-clockpicker.min.js')); ?>">
    </script>
    ...
    <script type="text/javascript" src="<?php echo e(asset('public/vendor/RangeSlider/ion.rangeSlider.min.js')); ?>"></script>
    ...
    <script type="text/javascript" src="<?php echo e(asset('public/vendor/datatable/datatable.responsive.boostrap.min.js')); ?>">
    </script>
...
<body>
                ...
                <div class="navbar-holder d-flex align-items-center justify-content-between">
                    ...
                    <span class="brand-big" id="site_logo_main">
                        <?php if($general_settings->site_logo ?? 'no'): ?>
                            <img src="<?php echo e(url('public/logo', $general_settings->site_logo ?? 'no')); ?>"
                                width="50">&nbsp;
                            &nbsp;
                        <?php endif; ?>
                        <h1 class="d-inline" id="site_title_main"><?php echo e($general_settings->site_title ?? 'No title'); ?>
                            ...
                            <ul class="right-sidebar">
                                ...
                                <?php $__currentLoopData = auth()->user()->notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><a class="unread-notification"
                                            href=<?php echo e($notification->data['link']); ?>><?php echo e($notification->data['data']); ?></a>
                                    </li>
    ...
    <nav class="side-navbar">
        <div class="side-navbar-wrapper">
            ...
            <div class="main-menu">
                        ...
                        <ul id="employees" class="collapse list-unstyled ">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-details-employee')): ?>
                                <li id="employee_list"><a
                                        href="<?php echo e(route('employees.index')); ?>"><?php echo e(__('Employees')); ?></a></li>
                            <?php endif; ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('event-meeting')): ?>
                    <li
                        class="has-dropdown <?php if(request()->is('events*')): ?> <?php echo e(request()->is('events*') ? 'active' : ''); ?><?php elseif(request()->is('meetings*')): ?><?php echo e(request()->is('meetings*') ? 'active' : ''); ?> <?php endif; ?>">

                        <?php if(auth()->user()->can('view-event') ||
                            auth()->user()->can('view-meeting')): ?>
                            <a href="#Events_Meetings" aria-expanded="false" data-toggle="collapse"> <i
                                    class="dripicons-to-do"></i><span><?php echo e(trans('file.Events')); ?> &
                                    <?php echo e(trans('file.Meetings')); ?></span>
                            </a>
                        <?php endif; ?>
        ...
        <li class="has-dropdown <?php echo e(request()->is('timesheet*') ? 'active' : ''); ?>"><a
            ...
            <ul id="Timesheets" class="collapse list-unstyled ">
                ...
                <li id="date_wise_attendance"><a href="<?php echo e(route('date_wise_attendances.index')); ?>">
                        <?php echo e(__('Date wise Attendances')); ?></a>
                </li>


                <li id="monthly_attendance"><a href="<?php echo e(route('monthly_attendances.index')); ?>">
                        <?php echo e(__('Monthly Attendances')); ?></a>
                </li>
                

                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit-attendance')): ?>
                    <li id="update_attendance"><a href="<?php echo e(route('update_attendances.index')); ?>">
                            <?php echo e(__('Update Attendances')); ?></a>
                    </li>
                <?php endif; ?>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('training_module')): ?>
            <li
                class="has-dropdown <?php if(request()->is('training*')): ?> <?php echo e(request()->is('training*') ? 'active' : ''); ?><?php elseif(request()->is('dynamic_variable/training_type*')): ?><?php echo e(request()->is('dynamic_variable/training_type*') ? 'active' : ''); ?> <?php endif; ?>">
                <?php if(auth()->user()->can('view-training') ||
...
<li class="has-dropdown <?php echo e(request()->is('file_manager*') ? 'active' : ''); ?>">
    ...
    <?php if(auth()->user()->can('view-file_manager') ||
...
class="external"><?php echo e($general_settings->footer); ?></a></p>
</div>
</footer>
</div>
...
<?php /**PATH C:\xampp\htdocs\public\shariqq\black_htm\resources\views/layout/main.blade.php ENDPATH**/ ?>